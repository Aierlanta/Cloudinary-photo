...
async function validateAndParseParams(
  ...
  // 保留查询参数（不参与业务参数校验）
  const RESERVED_PARAMS = new Set(['key', 'response', 'origin', 'format', 'quality', 't', 'orientation', 'width', 'height', 'fit', 'opacity', 'bgColor', 'timeWindow', 'timeWeight', 'timeStart', 'timeEnd', 'timeZone']);
