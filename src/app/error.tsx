    ...
    <div className="min-h-screen flex items-center justify-center bg-polka px-4">
      <div className="max-w-lg w-full">
        <div className="dialogue-box relative p-8 pt-12 text-center">
          ...
          {/* 错误图标 */}
          <div className="mx-auto w-20 h-20 bg-red-100 dark:bg-red-900/40 rounded-full flex items-center justify-center mb-6">
            <svg
              className="w-10 h-10 text-red-500 dark:text-red-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
