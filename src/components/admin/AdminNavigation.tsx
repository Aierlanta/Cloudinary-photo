...
export default function AdminNavigation({ onLogout }: AdminNavigationProps) {
  ...
  return (
    <nav className={`fixed left-0 top-0 h-full transparent-panel shadow-lg transition-all duration-300 z-40 ${
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={`flex items-center px-3 py-2 rounded-lg transition-colors ${
                      isActive
                        ? 'bg-blue-500 bg-opacity-20 text-blue-600 dark:text-blue-400'
