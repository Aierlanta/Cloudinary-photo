    ...
    <div className="space-y-4">
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <p className="text-lg font-medium panel-text">
              拖拽图片到此处，或
              <button
                type="button"
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 panel-text mt-1">
      ...
      {selectedFiles.length > 0 && (
        <div className="space-y-2">
          <h3 className="font-medium panel-text">已选择的文件 ({selectedFiles.length})</h3>
            ...
            {selectedFiles.map((file, index) => (
              <div key={index} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium panel-text">{file.name}</p>
